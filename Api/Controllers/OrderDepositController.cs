...
namespace Api.Controllers
{
    ...
    [ApiController]
    public class OrderDepositController : ControllerBase
    {
        // GET: api/User
        [HttpGet]
        ...
        {
            int total;
            List<OrderDeposit> roleList = OrderDepositBLL.GetOrderDepositList(param, out total);
        ...
        public MyResult GetDetail([FromQuery] OrderInfoParam param)
        {
            ...
            OrderDeposit depositInfo = OrderBLL.GetDepositInfo(param.OrderNo);
